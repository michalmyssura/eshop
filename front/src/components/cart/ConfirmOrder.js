...
const ConfirmOrder = ({ history }) => {
    ...
    const taxPrice = Number((0.23 * itemsPrice).toFixed(2))
            ...
            <div className="row d-flex justify-content-between">
                            ...
                            <div className="cart-item my-1" key={item.product}>
                                <div className="row">
                                    ...
                                    <div className="col-4 col-lg-4 mt-4 mt-lg-0">
                                        <p>{item.quantity} x {item.price} zł = <b>{(item.quantity * item.price).toFixed(2)}zł</b></p>
                                    </div>
                ...
                <div className="col-12 col-lg-3 my-4">
                    <div id="order_summary">
                        ...
                        <hr />
                        <p>Cena:  <span className="order-summary-values">{itemsPrice} zł</span></p>
                        <p>Dostawa: <span className="order-summary-values">{shippingPrice}zł</span></p>

                        <hr />

                        <p>Cena końcowa: <span className="order-summary-values">{totalPrice}zł</span></p>
